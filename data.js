...
const FLOW_DATA = {
  ...
  // ----------------------------------------------------
  // NÓS COM COORDENADAS PRECISAS E ESPAÇADAS (GRID BPMN)
  // ----------------------------------------------------
  nodes: [
    // ====================================================
    // RAIA 1: SUPORTE (Y range: 30 a 260)
    // ====================================================
    {
      id: "sup_start",
      lane: "suporte",
      ...
      details: {
        ...
        tools: ["WhatsApp Business API", "Portal de Atendimento"],
        whatWeDo: "O cliente ou revenda reporta uma dúvida, lentidão ou comportamento inesperado.",
        checklist: ["Identificar CNPJ/Razão Social", "Identificar módulo afetado (PDV, PAY, Retaguarda)"],
    ...
    },
    {
      ...
      details: {
        ...
        tools: ["Zendesk Support"],
        whatWeDo: "O chamado é categorizado com protocolo único para controle de SLA.",
        checklist: ["Número de ticket válido", "Preenchimento de campos obrigatórios"],
    ...
    },
    {
      ...
      details: {
        ...
        tools: ["Zendesk", "AnyDesk / TeamViewer"],
        whatWeDo: "Identifica se é dúvida de uso, parametrização ou anomalia real.",
        checklist: ["Passo a passo realizado", "Mensagem de erro", "Frequência de ocorrência"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Consultou FAQ/Wiki?", "Verificou permissões?"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Confirmação do cliente", "Fechamento com macro adequada"],
    ...
    },
    {
      ...
      details: {
        ...
        tools: ["Ambiente Local de Testes"],
        whatWeDo: "Executa o mesmo passo a passo para confirmar se o erro se repete.",
        checklist: ["Mesma versão da aplicação", "Parâmetros idênticos"],
    ...
    },
    {
      ...
      details: {
        ...
        tools: ["Checklist de Evidências"],
        whatWeDo: "Classifica se o chamado envolve frente de caixa/TEF ou retaguarda.",
        checklist: ["Envolve emissão fiscal ou cartão/TEF/PIX?"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Suporte N2",
        tools: ["Ambiente de Teste"],
        whatWeDo: "Avalia se realmente necessita de escalonamento para a Análise.",
        checklist: ["Testado em outra base?", "Descartado dado corrompido isolado?"],
    ...
    },
    {
      ...
      x: 955,
      y: 200,
      annotation: "Obrigatório: Backup do Banco, Logs PDV/PAY/Integra/Serviços e Vídeo da Rotina",
      details: {
        summary: "ETAPA CRÍTICA: Coleta obrigatória de insumos técnicos para a reprodução.",
        responsible: "Analista de Suporte",
        tools: ["Backup ZIP", "Logs de Serviços", "Gravador de Vídeo"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Todos os anexos presentes", "Relato do esperado x ocorrido"],
    ...
    // ====================================================
    {
      ...
      details: {
        ...
        checklist: ["Descrição clara", "Anexos presentes"],
    ...
    },
    {
      ...
      details: {
        ...
        tools: ["Zendesk", "Jira Search"],
        whatWeDo: "Valida se os arquivos estão íntegros e se o relato é compreensível.",
        checklist: ["Logs abrem corretamente?", "Versão é suportada?"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Cenário depende de cadastro específico ou geral?"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Busca por rotina no Jira", "Checagem de QPs abertos"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Ponto Focal",
        tools: ["Ambiente Local"],
        whatWeDo: "Realiza a rotina exata para confirmar a anomalia.",
        checklist: ["Prints e evidências do teste interno"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Teste na versão do cliente", "Teste na versão mais recente"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Número da QP vinculada"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Status no Jira", "Versão de liberação"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Print da versão corrigida", "Orientação de atualização"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Ponto Focal",
        tools: ["Critérios de Aceite"],
        whatWeDo: "Se o problema for real e possuir evidências completas, aprova.",
        checklist: ["Pacote completo?", "Problema reproduzido?"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Motivo claro selecionado"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Logs/prints anexados", "Orientações claras para o Suporte"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Tags aplicadas", "Resumo do Ponto Focal anexado"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Ticket atribuído à Análise Técnica"],
        impact: "Início do diagnóstico aprofundado."
      }
    },

    // ====================================================
    // RAIA 3: ANÁLISE TÉCNICA (Y range: 30 a 380)
    // ====================================================
    {
      id: "tech_link_p02",
      ...
      details: {
        ...
        tools: ["Zendesk", "Painel da Análise"],
        whatWeDo: "Recebe o chamado validado com pacote completo de evidências.",
        checklist: ["Conferência dos arquivos recebidos"],
    ...
    },
    {
      ...
      details: {
        ...
        tools: ["Ambientes Virtuais", "Zendesk"],
        whatWeDo: "Examina logs e versões para planejar o método de reprodução.",
        checklist: ["Identificar serviços de background (Integra, Automação)"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Analista Técnico",
        tools: ["SQL Server / PostgreSQL", "Simuladores TEF"],
        whatWeDo: "Se for PDV/PAY, restaura banco e analisa logs de serviços.",
        checklist: ["Espaço em disco e emulador de PDV disponíveis"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Analista Técnico",
        tools: ["Storage Seguro / Sandbox"],
        whatWeDo: "Descompacta logs e banco em diretórios estruturados.",
        checklist: ["Integridade do arquivo .BAK / .ZIP verificada"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Analista Técnico",
        tools: ["SQL Server Management Studio", "VSCode / Log Parser"],
        whatWeDo: "Busca StackTraces, exceções não tratadas, timeouts de API e deadlocks.",
        checklist: ["Versão do banco compatível", "Timestamp cruzado com o ticket"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Analista Técnico",
        tools: ["Ambiente de Simulação Multi-versão"],
        whatWeDo: "Executa a rotina gravando a tela e monitorando tráfego de API.",
        checklist: ["Todas as evidências coletadas", "100% de reproducibilidade obtida"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Analista Técnico",
        tools: ["Módulos Retaguarda"],
        whatWeDo: "Verifica regras fiscais, relatórios e integrações contábeis.",
        checklist: ["Teste de regressão na versão recente"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Script de correção validado", "Prints explicativos anexados"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Validação com o solicitante"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Projeto correto no Jira selecionado"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Analista Técnico",
        tools: ["Jira Issue Tracker"],
        whatWeDo: "Cria a issue classificando tipo, severidade, módulo e versão afetada.",
        checklist: ["Campos obrigatórios preenchidos", "Versão afetada informada"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Analista Técnico",
        tools: ["Jira Markdown", "Vídeos MP4", "Logs Tratados", "Bancos Sanitizados"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Classificação correta de Issue Type"],
    ...
    },
    {
      ...
      details: {
        ...
        tools: ["Reunião de Estimativa / Refinement"],
        whatWeDo: "Apresenta volume de clientes impactados e benefício da melhoria.",
        checklist: ["Volume de chamados correlatos", "Estimativa de Story Points"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Alocação em release futuro"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Notificação ao PO responsável"],
    ...
    },
    {
      ...
      details: {
        ...
        tools: ["Jira Sprint Board", "GitLab / GitHub"],
        whatWeDo: "Monitora os status de desenvolvimento e branch da correção.",
        checklist: ["Acompanhamento de prazos de sprint"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Analista Técnico",
        tools: ["Jira Status (Ready for QA)"],
        whatWeDo: "Se o dev finalizou, avança para verificação técnica.",
        checklist: ["Versão da build gerada pelo pipeline CI/CD"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Analista Técnico",
        tools: ["Jira / Git Commit Notes"],
        whatWeDo: "Entende o que foi alterado e o impacto colateral potencial.",
        checklist: ["Entender a lógica do ajuste aplicado"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Analista Técnico",
        tools: ["Critérios de Homologação"],
        whatWeDo: "Se passar 100%, homologa e libera. Se falhar, reprova para o Dev.",
        checklist: ["Evidências do teste com sucesso anexadas"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Analista Técnico",
        tools: ["Jira / Gravador de Tela"],
        whatWeDo: "Grava vídeo e logs demonstrando onde a correção falhou.",
        checklist: ["Logs com a nova falha", "Vídeo comprovando a não conformidade"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Analista Técnico",
        tools: ["Jira (Status: Reopened / Failed QA)"],
        whatWeDo: "Reabre a issue com as evidências do teste que falhou.",
        checklist: ["Notificação ao desenvolvedor e PO"],
    ...
    },
    {
      ...
      details: {
        ...
        responsible: "Analista Técnico",
        tools: ["Jira (Status: Closed / Released)", "Zendesk"],
    ...
    },
    {
      ...
      details: {
        ...
        checklist: ["Pesquisa de satisfação disparada"],
  ...
  connections: [
    // Suporte Lane
    { from: "sup_start", to: "sup_zendesk" },
    { from: "sup_zendesk", to: "sup_interact" },
    { from: "sup_interact", to: "sup_gw_need_analysis" },
    { from: "sup_gw_need_analysis", to: "sup_resolve_direct", label: "NÃO" },
    { from: "sup_gw_need_analysis", to: "sup_simulate", label: "SIM" },
    { from: "sup_resolve_direct", to: "sup_end_1" },
    { from: "sup_simulate", to: "sup_gw_pdv_pay" },
    { from: "sup_gw_pdv_pay", to: "sup_collect_evidence", label: "SIM" },
    { from: "sup_gw_pdv_pay", to: "sup_gw_need_forward", label: "NÃO" },
    { from: "sup_gw_need_forward", to: "sup_resolve_direct", label: "NÃO" },
    { from: "sup_gw_need_forward", to: "sup_collect_evidence", label: "SIM" },
    { from: "sup_collect_evidence", to: "sup_forward_focal" },
    { from: "sup_forward_focal", to: "sup_link_p01" },

    // Ponto Focal Lane
    { from: "focal_link_p01", to: "focal_analyze" },
    { from: "focal_analyze", to: "focal_gw_test_db" },
    { from: "focal_gw_test_db", to: "focal_check_qp", label: "SIM" },
    { from: "focal_gw_test_db", to: "focal_sim_client_db", label: "NÃO" },
    { from: "focal_check_qp", to: "focal_sim_test_db" },
    { from: "focal_sim_test_db", to: "focal_gw_need_deep" },
    { from: "focal_sim_client_db", to: "focal_gw_found_qp" },
    { from: "focal_gw_found_qp", to: "focal_gw_need_deep", label: "NÃO" },
    { from: "focal_gw_found_qp", to: "focal_gw_qp_done", label: "SIM" },
    { from: "focal_gw_qp_done", to: "focal_link_qp", label: "NÃO" },
    { from: "focal_gw_qp_done", to: "focal_sim_ticket", label: "SIM" },
    { from: "focal_link_qp", to: "focal_approve" },
    { from: "focal_sim_ticket", to: "focal_reject" },
    { from: "focal_gw_need_deep", to: "focal_reject", label: "NÃO" },
    { from: "focal_gw_need_deep", to: "focal_approve", label: "SIM" },
    { from: "focal_reject", to: "focal_reject_detail" },
    { from: "focal_reject_detail", to: "sup_resolve_direct", label: "Retorno" },
    { from: "focal_approve", to: "focal_link_p02" },

    // Análise Técnica Lane
    { from: "tech_link_p02", to: "tech_analyze" },
    { from: "tech_analyze", to: "tech_gw_pdv_pay" },
    { from: "tech_gw_pdv_pay", to: "tech_sim_diff_versions", label: "NÃO" },
    { from: "tech_gw_pdv_pay", to: "tech_download_assets", label: "SIM" },
    { from: "tech_download_assets", to: "tech_restore_logs" },
    { from: "tech_restore_logs", to: "tech_sim_env" },
    { from: "tech_sim_diff_versions", to: "tech_gw_is_bug" },
    { from: "tech_sim_env", to: "tech_gw_is_bug" },
    { from: "tech_gw_is_bug", to: "tech_detail_analysis", label: "NÃO" },
    { from: "tech_detail_analysis", to: "tech_return_client" },
    { from: "tech_return_client", to: "tech_end_not_bug" },
    { from: "tech_gw_is_bug", to: "tech_jira_access", label: "SIM" },
    { from: "tech_jira_access", to: "tech_open_qp" },
    { from: "tech_open_qp", to: "tech_doc_qp" },
    { from: "tech_doc_qp", to: "tech_gw_type" },
    { from: "tech_gw_type", to: "tech_send_po_queue", label: "SIM (Ajuste)" },
    { from: "tech_gw_type", to: "tech_po_estimate", label: "NÃO (Melhoria)" },
    { from: "tech_po_estimate", to: "tech_gw_approved_est" },
    { from: "tech_gw_approved_est", to: "tech_send_po_queue", label: "SIM" },
    { from: "tech_send_po_queue", to: "tech_wait_dev_1" },
    { from: "tech_wait_dev_1", to: "tech_gw_qp_completed" },
    { from: "tech_gw_qp_completed", to: "tech_wait_dev_1", label: "NÃO" },
    { from: "tech_gw_qp_completed", to: "tech_verify_dev", label: "SIM" },
    { from: "tech_verify_dev", to: "tech_sim_fixed" },
    { from: "tech_sim_fixed", to: "tech_gw_homologated" },
    { from: "tech_gw_homologated", to: "tech_homologate_success", label: "SIM" },
    { from: "tech_gw_homologated", to: "tech_doc_failed_tests", label: "NÃO" },
    { from: "tech_doc_failed_tests", to: "tech_return_dev_failed" },
    { from: "tech_return_dev_failed", to: "tech_wait_dev_2" },
    { from: "tech_wait_dev_2", to: "tech_gw_qp_completed" },
    { from: "tech_homologate_success", to: "tech_end_success" }
  ],
  ...
  // ----------------------------------------------------
  // APRESENTAÇÃO EXECUTIVA E INSTRUCIONAL (MODO SLIDES)
  // ----------------------------------------------------
  presentationSteps: [
    {
      id: "intro",
      ...
      focusNodes: ["sup_start", "focal_link_p01", "tech_link_p02"],
      badge: "Panorama Geral",
      badgeColor: "#38BDF8",
      content: {
        headline: "Transformando relatos de suporte em engenharia de diagnóstico estruturada",
        pillars: [
          { icon: "shield-check", title: "Blindagem do Dev", desc: "Filtramos chamados incompletos para que os desenvolvedores foquem 100% em codificar correções definitivas.", color: "#38BDF8" },
          { icon: "microscope", title: "Diagnóstico Científico", desc: "Restauramos a base real do cliente e mineramos logs em nível de milissegundo para encontrar a causa raiz.", color: "#818CF8" },
          { icon: "award", title: "Qualidade Garantida", desc: "Homologamos rigorosamente cada alteração antes de qualquer liberação para revendas e clientes finais.", color: "#34D399" }
        ],
        points: [
        ...
        kpi: { label: "Redução de Retrabalho no Dev", value: "Até 70%" }
      },
    ...
    },
    {
      ...
      focusNodes: ["sup_start", "sup_zendesk", "sup_interact", "sup_gw_need_analysis", "sup_simulate", "sup_gw_pdv_pay", "sup_collect_evidence", "sup_forward_focal"],
      badge: "Raia Suporte (N1/N2)",
      badgeColor: "#38BDF8",
      content: {
        headline: "O Suporte é o primeiro filtro e o responsável pela coleta dos insumos de reprodução",
        pillars: [
          { icon: "database", title: "Backup do Banco", desc: "Arquivo .BAK ou .DUMP recente do cliente. Sem o banco, simular comportamentos específicos é inviável.", color: "#38BDF8" },
          { icon: "file-text", title: "Logs de Serviços", desc: "Logs do PDV, PAY/TEF, Integra e Automação da mesma data/hora do evento relatado pelo cliente.", color: "#818CF8" },
          { icon: "video", title: "Vídeo da Rotina", desc: "Gravação curta demonstrando exatamente o passo a passo que gerou o comportamento ou erro.", color: "#F59E0B" }
        ],
        points: [
        ...
        kpi: { label: "Insumos Obrigatórios Coletados", value: "6 Itens" }
      },
    ...
    },
    {
      ...
      focusNodes: ["focal_link_p01", "focal_analyze", "focal_gw_test_db", "focal_check_qp", "focal_sim_test_db", "focal_gw_found_qp", "focal_gw_need_deep", "focal_reject", "focal_approve"],
      badge: "Raia Ponto Focal",
      badgeColor: "#818CF8",
      content: {
        headline: "Garantindo que apenas demandas estruturadas e inéditas cheguem à Análise Técnica",
        pillars: [
          { icon: "check-circle-2", title: "Auditoria de Insumos", desc: "Verifica se os arquivos anexados pelo suporte estão íntegros, legíveis e com o vídeo da rotina.", color: "#818CF8" },
          { icon: "search", title: "Busca de QPs Ativas", desc: "Pesquisa no Jira se o problema já foi identificado e está sendo corrigido pelo Desenvolvimento.", color: "#38BDF8" },
          { icon: "message-square-dashed", title: "Devolutiva Educativa", desc: "Se faltarem evidências, o ticket é devolvido com checklist claro do que falta coletar.", color: "#F43F5E" }
        ],
        points: [
        ...
        kpi: { label: "Economia de Tempo por QP Mapeado", value: "2h a 8h" }
      },
    ...
    },
    {
      ...
      focusNodes: ["tech_link_p02", "tech_analyze", "tech_download_assets", "tech_restore_logs", "tech_sim_env", "tech_gw_is_bug", "tech_jira_access", "tech_open_qp", "tech_doc_qp"],
      badge: "Raia Análise Técnica",
      badgeColor: "#34D399",
      content: {
        headline: "Engenharia de precisão para reproduzir a falha e isolar a causa raiz",
        pillars: [
          { icon: "server", title: "Sandbox Isolada", desc: "Restauração do banco em servidor SQL seguro e configuração de simuladores fiscais/TEF.", color: "#34D399" },
          { icon: "terminal", title: "Mineração de Logs", desc: "Análise profunda de StackTraces, exceções e concorrência de queries SQL.", color: "#38BDF8" },
          { icon: "file-code", title: "Documentação de QP", desc: "Criação de issue completa no Jira com passo a passo 100% reproduzível e evidências anexadas.", color: "#818CF8" }
        ],
        points: [
        ...
        kpi: { label: "Taxa de Reprodução no Dev", value: "100% Clara" }
      },
    ...
    },
    {
      ...
      focusNodes: ["tech_gw_type", "tech_po_estimate", "tech_send_po_queue", "tech_wait_dev_1", "tech_gw_qp_completed", "tech_verify_dev", "tech_sim_fixed", "tech_gw_homologated", "tech_doc_failed_tests", "tech_return_dev_failed"],
      badge: "Ciclo de Homologação",
      badgeColor: "#F59E0B",
      content: {
        headline: "Garantindo que apenas correções 100% testadas cheguem à produção",
        pillars: [
          { icon: "users", title: "Comitê de POs", desc: "Defendemos a prioridade das melhorias e bugs junto aos Product Owners para entrada na Sprint.", color: "#F59E0B" },
          { icon: "git-pull-request", title: "Reteste com Base Real", desc: "Assim que o Dev conclui a alteração, retestamos a rotina na versão gerada usando o banco do cliente.", color: "#34D399" },
          { icon: "shield-alert", title: "Controle de Regressão", desc: "Se a correção quebrar outra rotina ou falhar, a QP é reprovada na hora com feedback técnico.", color: "#F43F5E" }
        ],
        points: [
        ...
        kpi: { label: "Zero Regressão em Produção", value: "Garantia QA" }
      },
    ...
    },
    {
      ...
      focusNodes: ["tech_homologate_success", "tech_end_success", "dev", "impl", "qa", "revenda", "comercial", "financeiro"],
      badge: "Impacto & Resultados",
      badgeColor: "#10B981",
      content: {
        headline: "O ciclo completo gerando transparência, satisfação e evolução contínua do produto",
        pillars: [
          { icon: "store", title: "Sucesso da Revenda", desc: "A revenda recebe laudo detalhado com a versão oficial corrigida e orientações claras de atualização.", color: "#10B981" },
          { icon: "trending-up", title: "Comercial & Retenção", desc: "Resoluções estruturadas geram confiança na marca, aumentam o NPS e evitam cancelamentos (churn).", color: "#38BDF8" },
          { icon: "layers", title: "Sinergia Total", desc: "Suporte, Análise, Dev, QA e POs trabalham em uma esteira única, sincronizada e sem atritos.", color: "#818CF8" }
        ],
        points: [
        ...
        kpi: { label: "Satisfação e Confiabilidade", value: "Nível Máximo" }
      },
  ...
  // ----------------------------------------------------
  // SIMULADOR DE CENÁRIOS ("A JORNADA DO CHAMADO")
  // ----------------------------------------------------
  scenarios: [
    {
  ...
  // ----------------------------------------------------
  // PLAYBOOK DE EVIDÊNCIAS (GUIA RÁPIDO PARA O SUPORTE)
  // ----------------------------------------------------
  evidencePlaybook: [
    {
      ...
      color: "#38BDF8",
      items: [
        { name: "Log do PDV", path: "C:\\Sistema\\PDV\\Logs\\PDV_YYYYMMDD.log", desc: "Registra cada evento de tecla, leitor de código de barras e emissão fiscal." },
        { name: "Backup do Banco Local", path: "C:\\Sistema\\PDV\\Data\\PDV.sqlite / .FDB / .BAK", desc: "Cópia compactada dos dados locais do terminal." },
        { name: "Log do Integra / Sincronizador", path: "C:\\Sistema\\PDV\\Logs\\Integra.log", desc: "Histórico de comunicação entre PDV e Retaguarda." },
        { name: "Vídeo da Rotina", path: "Gravação MP4 (OBS / Windows Game Bar)", desc: "Comprovação visual da tela e do comportamento do PDV." }
      ]
    },
    {
      ...
      color: "#10B981",
      items: [
        { name: "Log do PAY / Gerenciador TEF", path: "C:\\Client\\Logs\\TEF_YYYYMMDD.log", desc: "Rastreio das transações com adquirentes e pinpad." },
        { name: "Log da Automação Comercial", path: "C:\\Sistema\\Logs\\Automacao.log", desc: "Comunicação entre o PDV e a DLL do TEF." },
        { name: "Comprovante / NSU da Transação", path: "PDF / Foto do Cupom TEF", desc: "Identificador único da operadora para rastreio no gateway." }
      ]
    },
    {
      ...
      color: "#818CF8",
      items: [
        { name: "Backup Completo do Banco (SQL/PG)", path: "Arquivo .BAK ou .DUMP recente", desc: "Permite à Análise restaurar a base idêntica do cliente no laboratório." },
        { name: "Log de Serviços do Windows", path: "C:\\Sistema\\Services\\Logs\\*.log", desc: "Logs de mensageria, emissão de NF-e e conciliações automáticas." },
        { name: "XMLs / Arquivos Relacionados", path: "Arquivos de envio e retorno da SEFAZ", desc: "Para auditoria de regras de validação tributária." }
      ]
    }
  ]
};
